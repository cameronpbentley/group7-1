    ...
    return (
      <div className="min-h-screen bg-white-color text-black-color flex items-center justify-center py-20">
        <div className="text-center max-w-md px-4">
          <h1 className="hero-title text-3xl font-bold mb-4 text-gray">
            Friend Not Found
          </h1>
          <Link
            to="/friends"
            className="btn-primary inline-block px-6 py-3 rounded-lg shadow-md"
          >
            ← Back to Friends
          </Link>
        </div>
    ...
    <div className="min-h-screen bg-white-color text-black-color pt-20">
      ...
      <div className="sticky top-0 z-50 bg-white-color/95 backdrop-blur-sm border-b border-gray/30 py-4 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <Link
            to="/friends"
            className="btn-outline flex items-center gap-2 px-4 py-2 rounded-lg shadow-sm hover:shadow-md transition-shadow"
          >
            ← Back to Friends
          </Link>
        </div>
      ...
      <header className="relative min-h-[60vh] bg-gradient-to-br from-primary-color/10 to-white-color flex items-center">
        <div className="content-container flex flex-col lg:flex-row items-center gap-8 py-16">
          <img
            ...
            className="w-48 h-48 object-cover rounded-full shadow-2xl border-4 border-white-color"
          />

          <div className="flex-1 space-y-6 text-left">
            <h1 className="hero-title text-5xl lg:text-6xl font-bold">
              {user.username}
            </h1>
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div className="space-y-4 p-6 bg-white-color rounded-2xl shadow-md">
            ...
            <p className="text-gray">
              <strong>Email:</strong>
              <span className="font-medium block mt-1">{user.email}</span>
            </p>
          </div>
      ...
      <footer className="home-footer border-t border-gray/30 py-8">
        <p className="text-center text-gray text-sm">
          &copy; 2025 MovieApp. Connect with friends.
        </p>
      </footer>
    </div>
  );
